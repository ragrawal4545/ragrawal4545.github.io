...
{% include image.html url="\images\wildfire_risk.png" description="Fig 1. Factors affecting wildfire damage." %}

{% include image.html url="\images\image_wildfire.jpg" description="Fig 2. A US Wildfire." %}
...
{% include image.html url="\images\prediction_attributes.png" description="Fig 3. Attributes of the wildfire prediction dataset."%}
...
{% include image.html url="\images\risk_attributes.png" description="Fig 4. Attributes of the wildfire risk calculation dataset."%}
